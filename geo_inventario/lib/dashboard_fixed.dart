...
class _DashboardPageState extends State<DashboardPage>
  ...
  List<Map<String, dynamic>> inventoryAtDate = [];
  bool isLoading = true;
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final analysisResponse = await _loadAnalysis();
  ...
  Future<List<Map<String, dynamic>>> _loadAnalysis() async {
    return await _apiService.getAnalysis(
                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Text(
                                        selectedDate != null
                                            ? inventoryAtDate.length.toString()
                              ...
                              Expanded(
                                child: TextField(
                                  ...
                                  decoration: const InputDecoration(
                                    labelText: 'Fecha del Inventario',
                              ...
                              if (selectedDate != null)
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    final analysisData = await _loadAnalysis();
                                    setState(() {
                          ...
                          Text(
                            selectedDate != null
                                ? 'Inventario al ${selectedDate!.day}/${selectedDate!.month}/${selectedDate!.year}'
                                : 'Productos por Grupo',
                            style: const TextStyle(
                                ...
                                rows: analysis.map((item) {
                                  return DataRow(cells: [
                                    ...
                                    DataCell(Text(item['cantidad_saldo_actual']
                                            ?.toString() ??
                                        '0')),
                                    DataCell(Text((item['valor_saldo_actual']
                                            ?.toStringAsFixed(2)) ??
                                        '0.00')),
                                    DataCell(Text((item['costo_unitario']
                                            ?.toStringAsFixed(2)) ??
                                        '0.00')),
  ...
  Future<void> _applyDateFilter() async {
    ...
    try {
      final data = await _apiService.getInventoryAtDate(selectedDate!);
      final analysisData = await _loadAnalysis();
      setState(() {
        inventoryAtDate = data;
        analysis = analysisData;
        isLoading = false;
      });
    } catch (e) {
